class OutboundTimesToYellowsController < ApplicationController

  def january_days

    result = {}

    januarymondayrides = Rides.where('extract(month from pickup_hour) between 1 and 1').where('extract(isodow from pickup_hour) between 1 and 1').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    januarytuesdayrides = Rides.where('extract(month from pickup_hour) between 1 and 1').where('extract(isodow from pickup_hour) between 2 and 2').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    januarywednesdayrides = Rides.where('extract(month from pickup_hour) between 1 and 1').where('extract(isodow from pickup_hour) between 3 and 3').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    januarythursdayrides = Rides.where('extract(month from pickup_hour) between 1 and 1').where('extract(isodow from pickup_hour) between 4 and 4').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    januaryfridayrides = Rides.where('extract(month from pickup_hour) between 1 and 1').where('extract(isodow from pickup_hour) between 5 and 5').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    januarysaturdayrides = Rides.where('extract(month from pickup_hour) between 1 and 1').where('extract(isodow from pickup_hour) between 6 and 6').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    januarysundayrides = Rides.where('extract(month from pickup_hour) between 1 and 1').where('extract(isodow from pickup_hour) between 7 and 7').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
  ...
  def february_days
    ...
    februarymondayrides = Rides.where('extract(month from pickup_hour) between 2 and 2').where('extract(isodow from pickup_hour) between 1 and 1').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    februarytuesdayrides = Rides.where('extract(month from pickup_hour) between 2 and 2').where('extract(isodow from pickup_hour) between 2 and 2').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    februarywednesdayrides = Rides.where('extract(month from pickup_hour) between 2 and 2').where('extract(isodow from pickup_hour) between 3 and 3').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    februarythursdayrides = Rides.where('extract(month from pickup_hour) between 2 and 2').where('extract(isodow from pickup_hour) between 4 and 4').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    februaryfridayrides = Rides.where('extract(month from pickup_hour) between 2 and 2').where('extract(isodow from pickup_hour) between 5 and 5').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    februarysaturdayrides = Rides.where('extract(month from pickup_hour) between 2 and 2').where('extract(isodow from pickup_hour) between 6 and 6').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    februarysundayrides = Rides.where('extract(month from pickup_hour) between 2 and 2').where('extract(isodow from pickup_hour) between 7 and 7').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
  ...
  def march_days
    ...
    marchmondayrides = Rides.where('extract(month from pickup_hour) between 3 and 3').where('extract(isodow from pickup_hour) between 1 and 1').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    marchtuesdayrides = Rides.where('extract(month from pickup_hour) between 3 and 3').where('extract(isodow from pickup_hour) between 2 and 2').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    marchwednesdayrides = Rides.where('extract(month from pickup_hour) between 3 and 3').where('extract(isodow from pickup_hour) between 3 and 3').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    marchthursdayrides = Rides.where('extract(month from pickup_hour) between 3 and 3').where('extract(isodow from pickup_hour) between 4 and 4').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    marchfridayrides = Rides.where('extract(month from pickup_hour) between 3 and 3').where('extract(isodow from pickup_hour) between 5 and 5').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    marchsaturdayrides = Rides.where('extract(month from pickup_hour) between 3 and 3').where('extract(isodow from pickup_hour) between 6 and 6').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    marchsundayrides = Rides.where('extract(month from pickup_hour) between 3 and 3').where('extract(isodow from pickup_hour) between 7 and 7').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
  ...
  def april_days
    ...
    aprilmondayrides = Rides.where('extract(month from pickup_hour) between 4 and 4').where('extract(isodow from pickup_hour) between 1 and 1').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    apriltuesdayrides = Rides.where('extract(month from pickup_hour) between 4 and 4').where('extract(isodow from pickup_hour) between 2 and 2').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    aprilwednesdayrides = Rides.where('extract(month from pickup_hour) between 4 and 4').where('extract(isodow from pickup_hour) between 3 and 3').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    aprilthursdayrides = Rides.where('extract(month from pickup_hour) between 4 and 4').where('extract(isodow from pickup_hour) between 4 and 4').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    aprilfridayrides = Rides.where('extract(month from pickup_hour) between 4 and 4').where('extract(isodow from pickup_hour) between 5 and 5').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    aprilsaturdayrides = Rides.where('extract(month from pickup_hour) between 4 and 4').where('extract(isodow from pickup_hour) between 6 and 6').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    aprilsundayrides = Rides.where('extract(month from pickup_hour) between 4 and 4').where('extract(isodow from pickup_hour) between 7 and 7').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
  ...
  def may_days
    ...
    maymondayrides = Rides.where('extract(month from pickup_hour) between 5 and 5').where('extract(isodow from pickup_hour) between 1 and 1').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    maytuesdayrides = Rides.where('extract(month from pickup_hour) between 5 and 5').where('extract(isodow from pickup_hour) between 2 and 2').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    maywednesdayrides = Rides.where('extract(month from pickup_hour) between 5 and 5').where('extract(isodow from pickup_hour) between 3 and 3').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    maythursdayrides = Rides.where('extract(month from pickup_hour) between 5 and 5').where('extract(isodow from pickup_hour) between 4 and 4').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    mayfridayrides = Rides.where('extract(month from pickup_hour) between 5 and 5').where('extract(isodow from pickup_hour) between 5 and 5').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    maysaturdayrides = Rides.where('extract(month from pickup_hour) between 5 and 5').where('extract(isodow from pickup_hour) between 6 and 6').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    maysundayrides = Rides.where('extract(month from pickup_hour) between 5 and 5').where('extract(isodow from pickup_hour) between 7 and 7').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
  ...
  def june_days
    ...
    junemondayrides = Rides.where('extract(month from pickup_hour) between 6 and 6').where('extract(isodow from pickup_hour) between 1 and 1').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    junetuesdayrides = Rides.where('extract(month from pickup_hour) between 6 and 6').where('extract(isodow from pickup_hour) between 2 and 2').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    junewednesdayrides = Rides.where('extract(month from pickup_hour) between 6 and 6').where('extract(isodow from pickup_hour) between 3 and 3').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    junethursdayrides = Rides.where('extract(month from pickup_hour) between 6 and 6').where('extract(isodow from pickup_hour) between 4 and 4').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    junefridayrides = Rides.where('extract(month from pickup_hour) between 6 and 6').where('extract(isodow from pickup_hour) between 5 and 5').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    junesaturdayrides = Rides.where('extract(month from pickup_hour) between 6 and 6').where('extract(isodow from pickup_hour) between 6 and 6').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    junesundayrides = Rides.where('extract(month from pickup_hour) between 6 and 6').where('extract(isodow from pickup_hour) between 7 and 7').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
  ...
  def total_rides_per_day
    ...
    mondayrides = Rides.where('extract(isodow from pickup_hour) between 1 and 1').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    tuesdayrides = Rides.where('extract(isodow from pickup_hour) between 2 and 2').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    wednesdayrides = Rides.where('extract(isodow from pickup_hour) between 3 and 3').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    thursdayrides = Rides.where('extract(isodow from pickup_hour) between 4 and 4').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    fridayrides = Rides.where('extract(isodow from pickup_hour) between 5 and 5').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    saturdayrides = Rides.where('extract(isodow from pickup_hour) between 6 and 6').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    sundayrides = Rides.where('extract(isodow from pickup_hour) between 7 and 7').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
  ...
  def total_rides_per_month
    ...
    januaryrides = Rides.where('extract(month from pickup_hour) between 1 and 1').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    februaryrides = Rides.where('extract(month from pickup_hour) between 2 and 2').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    marchrides = Rides.where('extract(month from pickup_hour) between 3 and 3').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    aprilrides = Rides.where('extract(month from pickup_hour) between 4 and 4').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    mayrides = Rides.where('extract(month from pickup_hour) between 5 and 5').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
    ...
    junerides = Rides.where('extract(month from pickup_hour) between 6 and 6').where("service = ?", 'green').map{|r| r.outbound_to_yellow}.inject(:+)
